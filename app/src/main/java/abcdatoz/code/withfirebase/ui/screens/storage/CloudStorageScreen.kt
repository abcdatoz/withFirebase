...
@Composable
fun CloudStorageScreen(storage: CloudStorageManager,  modifier: Modifier = Modifier){

    val scope =  rememberCoroutineScope()
    val context = LocalContext.current
    val file = context.createImageFile()
    val uri =  FileProvider.getUriForFile(Objects.requireNonNull(context), "abcdatoz.code.withfirebase" + ".provider", file)
